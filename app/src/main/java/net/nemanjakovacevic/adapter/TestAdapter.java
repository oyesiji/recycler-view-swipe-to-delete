package net.nemanjakovacevic.adapter;
...
import net.nemanjakovacevic.recyclerviewswipetodelete.MainActivity;
import net.nemanjakovacevic.viewholder.TestViewHolder;
